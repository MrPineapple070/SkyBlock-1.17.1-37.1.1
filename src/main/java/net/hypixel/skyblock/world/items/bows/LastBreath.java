...
public class LastBreath extends ModBowItem {
	private static final List<Component> info = Arrays.asList(
			item_ability.copy().append(new TranslatableComponent("bow.last")).withStyle(ChatFormatting.GOLD),
			new TranslatableComponent("bow.last.0"), new TranslatableComponent("bow.last.1"));
