...
public class ZombieChestplate extends ModArmorItem {
	public ZombieChestplate() {
		super(ZombieSet.instance.getMaterial(), EquipmentSlot.CHEST, ItemProperties.combat_1,
