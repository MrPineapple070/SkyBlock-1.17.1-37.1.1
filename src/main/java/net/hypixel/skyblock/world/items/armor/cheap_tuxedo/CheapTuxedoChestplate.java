...
public class CheapTuxedoChestplate extends ModArmorItem {
	public CheapTuxedoChestplate() {
		super(CheapTuxedoSet.instance.getMaterial(), EquipmentSlot.CHEST, ItemProperties.miscellaneous_1,
