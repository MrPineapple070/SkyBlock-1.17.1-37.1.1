...
public class PigmanSword extends ModSwordItem {
	private static final List<Component> info = Arrays.asList(
			item_ability.copy().append(new TranslatableComponent("sword.pigman")).withStyle(ChatFormatting.GOLD),
			new TranslatableComponent("sword.pigman.0", StatString.defense, StatString.ability_damage));
