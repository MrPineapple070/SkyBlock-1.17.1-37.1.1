...
public class AdaptiveHelmet extends DungeonArmorItem {
	public AdaptiveHelmet() {
		super(AdaptiveSet.instance.getMaterial(), EquipmentSlot.HEAD, AdaptiveSet.instance.getRarity());
	}
