...
public class HolyDragonHelmet extends ModArmorItem {
	public HolyDragonHelmet() {
		super(HolyDragonSet.instance.getMaterial(), EquipmentSlot.HEAD, ItemProperties.combat_1,
