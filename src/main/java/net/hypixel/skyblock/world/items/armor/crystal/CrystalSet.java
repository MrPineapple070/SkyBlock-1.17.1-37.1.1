...
public class CrystalSet implements FullSetInformation {
	...
	private static final List<Component> fsb = Arrays.asList(full_set_bonus.copy()
			.append(new TranslatableComponent("armor.crystal.fsb")).withStyle(ChatFormatting.GOLD),
			new TranslatableComponent("armor.crystal.fsb.disc"));
	...
	public Map<String, Double> getBootsBuffs() {
		...
		temp.put(BuffBuilder.intelligence(), 60d);
	...
	public Map<String, Double> getChestplateBuffs() {
		...
		temp.put(BuffBuilder.intelligence(), 120d);
	...
	public Map<String, Double> getHelmetBuffs() {
		...
		temp.put(BuffBuilder.intelligence(), 65d);
