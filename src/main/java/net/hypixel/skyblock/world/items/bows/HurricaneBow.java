...
public class HurricaneBow extends ModBowItem {
	private static final List<Component> info = Arrays.asList(
			item_ability.copy().append(new TranslatableComponent("bow.hurricane")).withStyle(ChatFormatting.GOLD),
			new TranslatableComponent("bow.hurricane.0"), new TranslatableComponent("bow.hurricane.1"));
