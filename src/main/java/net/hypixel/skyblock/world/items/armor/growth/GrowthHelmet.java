...
/**
 * <a href=
 * "https://hypixel-skyblock.fandom.com/wiki/Armor_of_Growth#Helmet">GrowthSet
 * Helmet</a>
 *
...
public class GrowthHelmet extends ModArmorItem {
	public GrowthHelmet() {
		super(GrowthSet.instance.getMaterial(), EquipmentSlot.HEAD, ItemProperties.foraging_1,
