...
public class ThickScorpionFoil extends ModSwordItem {
	...
	private static final List<Component> after = Arrays.asList(
			new TranslatableComponent("sword.scorpion.0", StatString.health),
			new TranslatableComponent("sword.scorpion.1"));
	...
	@Override
	public void inventoryTick(ItemStack stack, Level level, Entity entity, int slot, boolean index) {
	...
	public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag flag) {
		tooltip.add(before);
		tooltip.add(new TranslatableComponent("sword.scorpion.ticker", this.tickers, StatString.ticker));
