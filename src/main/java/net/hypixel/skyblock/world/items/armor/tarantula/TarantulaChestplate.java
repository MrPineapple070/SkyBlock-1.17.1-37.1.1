...
public class TarantulaChestplate extends ModArmorItem {
	private static final List<Component> info = Arrays.asList(
			...
			new TranslatableComponent("armor.extra_bonus", new TranslatableComponent("armor.tarantula_chest")).withStyle(ChatFormatting.GOLD),
			new TranslatableComponent("armor.tarantla.chest")
			);

	public TarantulaChestplate() {
		super(TarantulaSet.instance.getMaterial(), EquipmentSlot.CHEST, ItemProperties.combat_1,
