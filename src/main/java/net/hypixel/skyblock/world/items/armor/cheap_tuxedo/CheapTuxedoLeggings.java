...
public class CheapTuxedoLeggings extends ModArmorItem {
	public CheapTuxedoLeggings() {
		super(CheapTuxedoSet.instance.getMaterial(), EquipmentSlot.LEGS, ItemProperties.miscellaneous_1,
