...
public class ZombieSword extends ModSwordItem {
	private static final List<Component> info = Arrays.asList(
			item_ability.copy().append(new TranslatableComponent("sword.zombie")).withStyle(ChatFormatting.GOLD),
			new TranslatableComponent("sword.zombie.0", StatString.health));
