...
public class FarmSuitSet implements FullSetInformation {
	...
	private static final List<Component> fsb = Arrays.asList(
			...
			new TranslatableComponent("armor.farm.fsb.disc", StatString.speed), full_set_bonus.copy()
					.append(new TranslatableComponent("armor.farm_suit.fsb")).withStyle(ChatFormatting.GOLD),
			new TranslatableComponent("armor.farm_suit.fsb.disc"));
